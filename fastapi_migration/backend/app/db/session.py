...
def get_db_engine() -> sqlalchemy.engine.base.Engine:
    ...
    if Connector and os.environ.get("INSTANCE_CONNECTION_NAME"):
        ...
        db_user = os.environ.get("DB_USER", settings.POSTGRES_USER)
        db_pass = os.environ.get("DB_PASS", settings.POSTGRES_PASSWORD)
        db_name = os.environ.get("DB_NAME", settings.POSTGRES_DB)
